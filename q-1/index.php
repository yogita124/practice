<?php
    ...
    $student_details =  array( 
                array('sid' => '101', 'name' => 'Yogita', 'dob' => strtotime('19-12-1998'), 'class' =>'12', 'passed' => '0','marks'=>array('P'=>'56','C  '=>'12','M'=>'50') ),
                array('sid' => '102', 'name' => 'Zubin', 'dob' => strtotime('02-08-1999'), 'class' =>'10', 'passed' => '0','marks'=>array('SS'=>'30','S'=>'14','E'=>'03')),
                array('sid' => '103', 'name' => 'Yash', 'dob' => strtotime('24-03-2000'), 'class' =>'11', 'passed' => '0','marks'=>array('E'=>'30','B'=>'29','M'=>'35'))
                );
    ...
    function get_mark($marks) {
        echo '<table border = "1px"><tr><th>Student id</th><th>Subject Code</th><th>Marks Obtained</th></tr>';
            ...
            {
                echo "<tr><td>" . $mark['id'] . "</td><td>".$mark['code']."</td><td>".$mark['ob']."</td></tr>";        
            }
        echo '</table>';
    }
    get_mark($marks);
        ...
        foreach ($student_details as $key=>$value) {
            ...
            echo "<tr><td>" .$student_details[$key]['name']."</td><td>".$student_details[$key]['dob']."</td><td>".$student_details[$key]['class']."</td><td>";
                foreach ($arr as $key1=>$val) {
                    echo $key1."(".$student_details[$key]['marks'][$key1].",".$student_details[$key]['mm'][$key1].")"."<br>";
                }
            echo "</td><td>".$student_details[$key]['res']."</td></tr>";
        }
    }
